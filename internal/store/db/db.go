...
func Prepare(ctx context.Context, db DBTX) (*Queries, error) {
	...
	if q.createTraefikInstanceStmt, err = db.PrepareContext(ctx, createTraefikInstance); err != nil {
		return nil, fmt.Errorf("error preparing query CreateTraefikInstance: %w", err)
	}
	...
	if q.createUdpRouterDNSProviderStmt, err = db.PrepareContext(ctx, createUdpRouterDNSProvider); err != nil {
		return nil, fmt.Errorf("error preparing query CreateUdpRouterDNSProvider: %w", err)
	}
	...
	if q.deleteUdpRouterDNSProviderStmt, err = db.PrepareContext(ctx, deleteUdpRouterDNSProvider); err != nil {
		return nil, fmt.Errorf("error preparing query DeleteUdpRouterDNSProvider: %w", err)
	}
	...
	if q.getTraefikInstanceByProfileStmt, err = db.PrepareContext(ctx, getTraefikInstanceByProfile); err != nil {
		return nil, fmt.Errorf("error preparing query GetTraefikInstanceByProfile: %w", err)
	}
	...
	if q.listUdpRouterDNSProviderStmt, err = db.PrepareContext(ctx, listUdpRouterDNSProvider); err != nil {
		return nil, fmt.Errorf("error preparing query ListUdpRouterDNSProvider: %w", err)
	}
	...
	if q.updateTraefikInstanceStmt, err = db.PrepareContext(ctx, updateTraefikInstance); err != nil {
		return nil, fmt.Errorf("error preparing query UpdateTraefikInstance: %w", err)
	}
...
func (q *Queries) Close() error {
	...
	if q.createTraefikInstanceStmt != nil {
		if cerr := q.createTraefikInstanceStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing createTraefikInstanceStmt: %w", cerr)
		}
	}
	...
	if q.createUdpRouterDNSProviderStmt != nil {
		if cerr := q.createUdpRouterDNSProviderStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing createUdpRouterDNSProviderStmt: %w", cerr)
		}
	}
	...
	if q.deleteUdpRouterDNSProviderStmt != nil {
		if cerr := q.deleteUdpRouterDNSProviderStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing deleteUdpRouterDNSProviderStmt: %w", cerr)
		}
	}
	...
	if q.getTraefikInstanceByProfileStmt != nil {
		if cerr := q.getTraefikInstanceByProfileStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing getTraefikInstanceByProfileStmt: %w", cerr)
		}
	}
	...
	if q.listUdpRouterDNSProviderStmt != nil {
		if cerr := q.listUdpRouterDNSProviderStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing listUdpRouterDNSProviderStmt: %w", cerr)
		}
	}
	...
	if q.updateTraefikInstanceStmt != nil {
		if cerr := q.updateTraefikInstanceStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing updateTraefikInstanceStmt: %w", cerr)
		}
	}
...
type Queries struct {
	...
	createTraefikInstanceStmt         *sql.Stmt
	createUdpRouterStmt               *sql.Stmt
	createUdpRouterDNSProviderStmt    *sql.Stmt
	...
	deleteUdpRouterDNSProviderStmt    *sql.Stmt
	...
	listUdpRouterDNSProviderStmt      *sql.Stmt
	...
	updateTraefikInstanceStmt         *sql.Stmt
...
func (q *Queries) WithTx(tx *sql.Tx) *Queries {
	return &Queries{
		...
		createTraefikInstanceStmt:         q.createTraefikInstanceStmt,
		createUdpRouterStmt:               q.createUdpRouterStmt,
		createUdpRouterDNSProviderStmt:    q.createUdpRouterDNSProviderStmt,
		...
		deleteUdpRouterDNSProviderStmt:    q.deleteUdpRouterDNSProviderStmt,
		...
		listUdpRouterDNSProviderStmt:      q.listUdpRouterDNSProviderStmt,
		...
		updateTraefikInstanceStmt:         q.updateTraefikInstanceStmt,
