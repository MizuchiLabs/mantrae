...
<div class="flex flex-col gap-4">
	<div class="flex flex-col gap-2 rounded-lg border p-3">
		<Label class="pb-1 text-lg font-medium">Connection Timeouts</Label>

		<div class="space-y-2">
			<Label for="dialKeepAlive">Dial Keep Alive (ms)</Label>
			<Input
				id="dialKeepAlive"
				type="number"
				bind:value={config.dialKeepAlive}
				placeholder="15000"
			/>
		</div>
		<div class="space-y-2">
			<Label for="dialTimeout">Dial Timeout (ms)</Label>
			<Input id="dialTimeout" type="number" bind:value={config.dialTimeout} placeholder="30000" />
		</div>
		<div class="space-y-2">
			<Label for="terminationDelay">Termination Delay (ms)</Label>
			<Input
				id="terminationDelay"
				type="number"
				bind:value={config.terminationDelay}
				placeholder="100"
			/>
		</div>
	</div>
	...
	<div class="flex flex-col gap-2 rounded-lg border p-3">
		<Label class="pb-1 text-lg font-medium">TLS Configuration</Label>
