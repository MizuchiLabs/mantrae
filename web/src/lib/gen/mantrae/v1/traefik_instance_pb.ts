 ...
 */
export const file_mantrae_v1_traefik_instance: GenFile /*@__PURE__*/ = fileDesc(
 ...
 */
export const TraefikInstanceSchema: GenMessage<TraefikInstance> /*@__PURE__*/ = messageDesc(
