...
func (x *UpdateDnsProviderRequest) GetType() string {
	if x != nil {
		return x.Type
	}
	return ""
...
var file_mantrae_v1_dns_provider_proto_goTypes = []any{
	(*DnsProvider)(nil),               // 0: mantrae.v1.DnsProvider
	(*DnsProviderConfig)(nil),         // 1: mantrae.v1.DnsProviderConfig
	(*GetDnsProviderRequest)(nil),     // 2: mantrae.v1.GetDnsProviderRequest
	(*GetDnsProviderResponse)(nil),    // 3: mantrae.v1.GetDnsProviderResponse
	(*CreateDnsProviderRequest)(nil),  // 4: mantrae.v1.CreateDnsProviderRequest
	(*CreateDnsProviderResponse)(nil), // 5: mantrae.v1.CreateDnsProviderResponse
	(*UpdateDnsProviderRequest)(nil),  // 6: mantrae.v1.UpdateDnsProviderRequest
	(*UpdateDnsProviderResponse)(nil), // 7: mantrae.v1.UpdateDnsProviderResponse
	(*DeleteDnsProviderRequest)(nil),  // 8: mantrae.v1.DeleteDnsProviderRequest
	(*DeleteDnsProviderResponse)(nil), // 9: mantrae.v1.DeleteDnsProviderResponse
	(*ListDnsProvidersRequest)(nil),   // 10: mantrae.v1.ListDnsProvidersRequest
	(*ListDnsProvidersResponse)(nil),  // 11: mantrae.v1.ListDnsProvidersResponse
	(*timestamppb.Timestamp)(nil),     // 12: google.protobuf.Timestamp
}
var file_mantrae_v1_dns_provider_proto_depIdxs = []int32{
	1,  // 0: mantrae.v1.DnsProvider.config:type_name -> mantrae.v1.DnsProviderConfig
	12, // 1: mantrae.v1.DnsProvider.created_at:type_name -> google.protobuf.Timestamp
	12, // 2: mantrae.v1.DnsProvider.updated_at:type_name -> google.protobuf.Timestamp
	0,  // 3: mantrae.v1.GetDnsProviderResponse.dns_provider:type_name -> mantrae.v1.DnsProvider
	1,  // 4: mantrae.v1.CreateDnsProviderRequest.config:type_name -> mantrae.v1.DnsProviderConfig
	0,  // 5: mantrae.v1.CreateDnsProviderResponse.dns_provider:type_name -> mantrae.v1.DnsProvider
	1,  // 6: mantrae.v1.UpdateDnsProviderRequest.config:type_name -> mantrae.v1.DnsProviderConfig
	0,  // 7: mantrae.v1.UpdateDnsProviderResponse.dns_provider:type_name -> mantrae.v1.DnsProvider
	0,  // 8: mantrae.v1.ListDnsProvidersResponse.dns_providers:type_name -> mantrae.v1.DnsProvider
	2,  // 9: mantrae.v1.DnsProviderService.GetDnsProvider:input_type -> mantrae.v1.GetDnsProviderRequest
	4,  // 10: mantrae.v1.DnsProviderService.CreateDnsProvider:input_type -> mantrae.v1.CreateDnsProviderRequest
	6,  // 11: mantrae.v1.DnsProviderService.UpdateDnsProvider:input_type -> mantrae.v1.UpdateDnsProviderRequest
	8,  // 12: mantrae.v1.DnsProviderService.DeleteDnsProvider:input_type -> mantrae.v1.DeleteDnsProviderRequest
	10, // 13: mantrae.v1.DnsProviderService.ListDnsProviders:input_type -> mantrae.v1.ListDnsProvidersRequest
	3,  // 14: mantrae.v1.DnsProviderService.GetDnsProvider:output_type -> mantrae.v1.GetDnsProviderResponse
	5,  // 15: mantrae.v1.DnsProviderService.CreateDnsProvider:output_type -> mantrae.v1.CreateDnsProviderResponse
	7,  // 16: mantrae.v1.DnsProviderService.UpdateDnsProvider:output_type -> mantrae.v1.UpdateDnsProviderResponse
	9,  // 17: mantrae.v1.DnsProviderService.DeleteDnsProvider:output_type -> mantrae.v1.DeleteDnsProviderResponse
	11, // 18: mantrae.v1.DnsProviderService.ListDnsProviders:output_type -> mantrae.v1.ListDnsProvidersResponse
