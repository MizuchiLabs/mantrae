...
const file_mantrae_v1_dns_provider_proto_rawDesc = "" +
	...
	"mantrae.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\xac\x02\n" +
	...
	"\fdns_provider\x18\x01 \x01(\v2\x17.mantrae.v1.DnsProviderR\vdnsProvider\"\xb3\x01\n" +
	"\x18CreateDnsProviderRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12/\n" +
	"\x04type\x18\x02 \x01(\x0e2\x1b.mantrae.v1.DnsProviderTypeR\x04type\x125\n" +
	...
	"\fdns_provider\x18\x01 \x01(\v2\x17.mantrae.v1.DnsProviderR\vdnsProvider\"\xc3\x01\n" +
	"\x18UpdateDnsProviderRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12/\n" +
	"\x04type\x18\x03 \x01(\x0e2\x1b.mantrae.v1.DnsProviderTypeR\x04type\x125\n" +
	"\x06config\x18\x04 \x01(\v2\x1d.mantrae.v1.DnsProviderConfigR\x06config\x12\x1b\n" +
