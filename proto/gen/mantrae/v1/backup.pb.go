...
const file_mantrae_v1_backup_proto_rawDesc = "" +
	...
	"\x14CreateBackupResponse\"6\n" +
	"\x14RestoreBackupRequest\x12\x1e\n" +
	"\x04name\x18\x01 \x01(\tB\n" +
	"\xbaH\a\xc8\x01\x01r\x02\x10\x01R\x04name\"\x17\n" +
	"\x15RestoreBackupResponse\"\x14\n" +
	"\x12ListBackupsRequest\"C\n" +
	"\x13ListBackupsResponse\x12,\n" +
	"\abackups\x18\x01 \x03(\v2\x12.mantrae.v1.BackupR\abackups\"5\n" +
	"\x13DeleteBackupRequest\x12\x1e\n" +
	"\x04name\x18\x01 \x01(\tB\n" +
	"\xbaH\a\xc8\x01\x01r\x02\x10\x01R\x04name\"\x16\n" +
