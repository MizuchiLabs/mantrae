...
const file_mantrae_v1_middleware_proto_rawDesc = "" +
	...
	"mantrae.v1\x1a\x1bbuf/validate/validate.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xdb\x02\n" +
	"\n" +
	"Middleware\x12\x0e\n" +
	...
	"\x04type\x18\a \x01(\x0e2\x1a.mantrae.v1.MiddlewareTypeR\x04type\x129\n" +
	"\n" +
	"created_at\x18\b \x01(\v2\x1a.google.protobuf.TimestampR\tcreatedAt\x129\n" +
	"\n" +
	"updated_at\x18\t \x01(\v2\x1a.google.protobuf.TimestampR\tupdatedAt\"\xac\x03\n" +
	"\x06Plugin\x12\x0e\n" +
	...
	"\x04toml\x18\x03 \x01(\tR\x04toml\"o\n" +
	"\x14GetMiddlewareRequest\x12\x1a\n" +
	"\x02id\x18\x01 \x01(\x03B\n" +
	"\xbaH\a\xc8\x01\x01\"\x02 \x00R\x02id\x12;\n" +
	"\x04type\x18\x02 \x01(\x0e2\x1a.mantrae.v1.MiddlewareTypeB\v\xbaH\b\xc8\x01\x01\x82\x01\x02\x10\x01R\x04type\"O\n" +
	...
	"\x04type\x18\x04 \x01(\x0e2\x1a.mantrae.v1.MiddlewareTypeB\v\xbaH\b\xc8\x01\x01\x82\x01\x02\x10\x01R\x04type\x12/\n" +
	"\x06config\x18\x05 \x01(\v2\x17.google.protobuf.StructR\x06config\"R\n" +
	"\x18CreateMiddlewareResponse\x126\n" +
	"\n" +
	"middleware\x18\x01 \x01(\v2\x16.mantrae.v1.MiddlewareR\n" +
	"middleware\"\xdd\x01\n" +
	"\x17UpdateMiddlewareRequest\x12\x1a\n" +
	"\x02id\x18\x01 \x01(\x03B\n" +
	"\xbaH\a\xc8\x01\x01\"\x02 \x00R\x02id\x12\x1e\n" +
	"\x04name\x18\x02 \x01(\tB\n" +
	"\xbaH\a\xc8\x01\x01r\x02\x10\x01R\x04name\x12;\n" +
	"\x04type\x18\x03 \x01(\x0e2\x1a.mantrae.v1.MiddlewareTypeB\v\xbaH\b\xc8\x01\x01\x82\x01\x02\x10\x01R\x04type\x12/\n" +
	...
	"middleware\x18\x01 \x01(\v2\x16.mantrae.v1.MiddlewareR\n" +
	"middleware\"r\n" +
	"\x17DeleteMiddlewareRequest\x12\x1a\n" +
	"\x02id\x18\x01 \x01(\x03B\n" +
	"\xbaH\a\xc8\x01\x01\"\x02 \x00R\x02id\x12;\n" +
	"\x04type\x18\x02 \x01(\x0e2\x1a.mantrae.v1.MiddlewareTypeB\v\xbaH\b\xc8\x01\x01\x82\x01\x02\x10\x01R\x04type\"\x1a\n" +
	"\x18DeleteMiddlewareResponse\"\xef\x02\n" +
