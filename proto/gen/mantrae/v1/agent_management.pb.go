...
const file_mantrae_v1_agent_management_proto_rawDesc = "" +
	...
	"\x15BootstrapAgentRequest\x12\x1d\n" +
	"\n" +
	"profile_id\x18\x01 \x01(\x03R\tprofileId\x12\x14\n" +
	"\x05token\x18\x02 \x01(\tR\x05token\".\n" +
	"\x16BootstrapAgentResponse\x12\x14\n" +
	"\x05token\x18\x01 \x01(\tR\x05token2\xe4\x04\n" +
	...
	"\x10RotateAgentToken\x12#.mantrae.v1.RotateAgentTokenRequest\x1a$.mantrae.v1.RotateAgentTokenResponse\x12W\n" +
	"\x0eBootstrapAgent\x12!.mantrae.v1.BootstrapAgentRequest\x1a\".mantrae.v1.BootstrapAgentResponseB\xae\x01\n" +
