...
const file_mantrae_v1_service_proto_rawDesc = "" +
	...
	"mantrae.v1\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xbb\x02\n" +
	"\aService\x12\x0e\n" +
	...
	"\aservice\x18\x01 \x01(\v2\x13.mantrae.v1.ServiceR\aservice\"\xc2\x01\n" +
	...
	"\aservice\x18\x01 \x01(\v2\x13.mantrae.v1.ServiceR\aservice\"\x98\x01\n" +
	...
	"\x15DeleteServiceResponse\"\xbc\x01\n" +
	"\x13ListServicesRequest\x12\x1d\n" +
	"\n" +
	"profile_id\x18\x01 \x01(\x03R\tprofileId\x120\n" +
	"\x04type\x18\x02 \x01(\x0e2\x17.mantrae.v1.ServiceTypeH\x00R\x04type\x88\x01\x01\x12\x19\n" +
