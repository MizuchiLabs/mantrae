...
const file_mantrae_v1_service_proto_rawDesc = "" +
	...
	"mantrae.v1\x1a\x1bbuf/validate/validate.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x17mantrae/v1/router.proto\"\xbb\x02\n" +
	"\aService\x12\x0e\n" +
	...
	"\xbaH\a\xc8\x01\x01\"\x02 \x00R\x02id\x128\n" +
	"\x04type\x18\x02 \x01(\x0e2\x17.mantrae.v1.ServiceTypeB\v\xbaH\b\xc8\x01\x01\x82\x01\x02\x10\x01R\x04type\"C\n" +
	"\x12GetServiceResponse\x12-\n" +
	"\aservice\x18\x01 \x01(\v2\x13.mantrae.v1.ServiceR\aservice\"\xe7\x01\n" +
	"\x14CreateServiceRequest\x12)\n" +
	"\n" +
	"profile_id\x18\x01 \x01(\x03B\n" +
	"\xbaH\a\xc8\x01\x01\"\x02 \x00R\tprofileId\x12\x19\n" +
	"\bagent_id\x18\x02 \x01(\tR\aagentId\x12\x1e\n" +
	"\x04name\x18\x03 \x01(\tB\n" +
	"\xbaH\a\xc8\x01\x01r\x02\x10\x01R\x04name\x12/\n" +
	"\x06config\x18\x04 \x01(\v2\x17.google.protobuf.StructR\x06config\x128\n" +
	"\x04type\x18\x05 \x01(\x0e2\x17.mantrae.v1.ServiceTypeB\v\xbaH\b\xc8\x01\x01\x82\x01\x02\x10\x01R\x04type\"F\n" +
	"\x15CreateServiceResponse\x12-\n" +
	"\aservice\x18\x01 \x01(\v2\x13.mantrae.v1.ServiceR\aservice\"\xbd\x01\n" +
	"\x14UpdateServiceRequest\x12\x1a\n" +
	"\x02id\x18\x01 \x01(\x03B\n" +
	"\xbaH\a\xc8\x01\x01\"\x02 \x00R\x02id\x12\x1e\n" +
	"\x04name\x18\x02 \x01(\tB\n" +
	"\xbaH\a\xc8\x01\x01r\x02\x10\x01R\x04name\x12/\n" +
	"\x06config\x18\x03 \x01(\v2\x17.google.protobuf.StructR\x06config\x128\n" +
	"\x04type\x18\x04 \x01(\x0e2\x17.mantrae.v1.ServiceTypeB\v\xbaH\b\xc8\x01\x01\x82\x01\x02\x10\x01R\x04type\"F\n" +
	"\x15UpdateServiceResponse\x12-\n" +
	"\aservice\x18\x01 \x01(\v2\x13.mantrae.v1.ServiceR\aservice\"l\n" +
	"\x14DeleteServiceRequest\x12\x1a\n" +
	"\x02id\x18\x01 \x01(\x03B\n" +
	"\xbaH\a\xc8\x01\x01\"\x02 \x00R\x02id\x128\n" +
	"\x04type\x18\x02 \x01(\x0e2\x17.mantrae.v1.ServiceTypeB\v\xbaH\b\xc8\x01\x01\x82\x01\x02\x10\x01R\x04type\"\x17\n" +
	"\x15DeleteServiceResponse\"\xe9\x02\n" +
