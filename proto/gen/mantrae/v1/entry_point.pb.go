...
const file_mantrae_v1_entry_point_proto_rawDesc = "" +
	...
	"mantrae.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\xfe\x01\n" +
	"\n" +
	"EntryPoint\x12\x0e\n" +
	...
	"entryPoint\"\x85\x01\n" +
	"\x17CreateEntryPointRequest\x12\x1d\n" +
	"\n" +
	...
	"\x18DeleteEntryPointResponse\"\x84\x01\n" +
	"\x16ListEntryPointsRequest\x12\x1d\n" +
	"\n" +
