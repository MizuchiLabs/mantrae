...
const file_mantrae_v1_router_proto_rawDesc = "" +
	...
	"mantrae.v1\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xd3\x02\n" +
	"\x06Router\x12\x0e\n" +
	...
	"\x06router\x18\x01 \x01(\v2\x12.mantrae.v1.RouterR\x06router\"\xda\x01\n" +
	...
	"\x06router\x18\x01 \x01(\v2\x12.mantrae.v1.RouterR\x06router\"\xb0\x01\n" +
	"\x13UpdateRouterRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12/\n" +
	"\x06config\x18\x03 \x01(\v2\x17.google.protobuf.StructR\x06config\x12\x18\n" +
	"\aenabled\x18\x04 \x01(\bR\aenabled\x12*\n" +
	"\x04type\x18\x05 \x01(\x0e2\x16.mantrae.v1.RouterTypeR\x04type\"B\n" +
	...
	"\x14DeleteRouterResponse\"\xba\x01\n" +
	"\x12ListRoutersRequest\x12\x1d\n" +
	"\n" +
	"profile_id\x18\x01 \x01(\x03R\tprofileId\x12/\n" +
	"\x04type\x18\x02 \x01(\x0e2\x16.mantrae.v1.RouterTypeH\x00R\x04type\x88\x01\x01\x12\x19\n" +
