...
const file_mantrae_v1_router_proto_rawDesc = "" +
	...
	"mantrae.v1\x1a\x1bbuf/validate/validate.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xd3\x02\n" +
	"\x06Router\x12\x0e\n" +
	...
	"\x10GetRouterRequest\x12\x1a\n" +
	"\x02id\x18\x01 \x01(\x03B\n" +
	"\xbaH\a\xc8\x01\x01\"\x02 \x00R\x02id\x127\n" +
	"\x04type\x18\x02 \x01(\x0e2\x16.mantrae.v1.RouterTypeB\v\xbaH\b\xc8\x01\x01\x82\x01\x02\x10\x01R\x04type\"?\n" +
	"\x11GetRouterResponse\x12*\n" +
	"\x06router\x18\x01 \x01(\v2\x12.mantrae.v1.RouterR\x06router\"\xff\x01\n" +
	...
	"\x04type\x18\x06 \x01(\x0e2\x16.mantrae.v1.RouterTypeB\v\xbaH\b\xc8\x01\x01\x82\x01\x02\x10\x01R\x04type\"B\n" +
	"\x14CreateRouterResponse\x12*\n" +
	"\x06router\x18\x01 \x01(\v2\x12.mantrae.v1.RouterR\x06router\"\xd5\x01\n" +
	"\x13UpdateRouterRequest\x12\x1a\n" +
	"\x02id\x18\x01 \x01(\x03B\n" +
	...
	"\x04type\x18\x05 \x01(\x0e2\x16.mantrae.v1.RouterTypeB\v\xbaH\b\xc8\x01\x01\x82\x01\x02\x10\x01R\x04type\"B\n" +
	"\x14UpdateRouterResponse\x12*\n" +
	"\x06router\x18\x01 \x01(\v2\x12.mantrae.v1.RouterR\x06router\"j\n" +
	"\x13DeleteRouterRequest\x12\x1a\n" +
	"\x02id\x18\x01 \x01(\x03B\n" +
	"\xbaH\a\xc8\x01\x01\"\x02 \x00R\x02id\x127\n" +
	"\x04type\x18\x02 \x01(\x0e2\x16.mantrae.v1.RouterTypeB\v\xbaH\b\xc8\x01\x01\x82\x01\x02\x10\x01R\x04type\"\x16\n" +
	"\x14DeleteRouterResponse\"\xe7\x02\n" +
