...
const file_mantrae_v1_router_proto_rawDesc = "" +
	...
	"\x06router\x18\x01 \x01(\v2\x12.mantrae.v1.RouterR\x06router\"\x93\x02\n" +
	"\x13UpdateRouterRequest\x12\x1a\n" +
	"\x02id\x18\x01 \x01(\x03B\n" +
	"\xbaH\a\xc8\x01\x01\"\x02 \x00R\x02id\x12\x1e\n" +
	"\x04name\x18\x02 \x01(\tB\n" +
	"\xbaH\a\xc8\x01\x01r\x02\x10\x01R\x04name\x127\n" +
	"\x04type\x18\x03 \x01(\x0e2\x16.mantrae.v1.RouterTypeB\v\xbaH\b\xc8\x01\x01\x82\x01\x02\x10\x01R\x04type\x12/\n" +
	"\x06config\x18\x04 \x01(\v2\x17.google.protobuf.StructR\x06config\x12\x18\n" +
